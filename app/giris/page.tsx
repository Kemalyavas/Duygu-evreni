...
export default function LoginPage() {
  ...
  const handleForgotPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setResetError(err instanceof Error ? err.message : t('errors.generic'))
    } finally {
      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/[0.03] border border-white/[0.08] rounded-2xl p-8 shadow-2xl">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-white/50 mt-3 text-base">{t('auth.loginSubtitle')}</p>
          </div>
          ...
          <div className="flex items-center gap-4 my-6">
            ...
            <span className="text-white/30 text-sm">{t('common.or') || 'or'}</span>
            <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/10 to-transparent" />
          </div>
          ...
          >
            {resetSuccess ? (
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-white mb-2">{t('auth.resetEmailSent')}</h3>
                <p className="text-white/60 mb-4 text-sm">
                  <strong className="text-cyan-300">{resetEmail}</strong>
                </p>
                <button
                  onClick={() => {
              ...
              <>
                <h3 className="text-xl font-bold text-white mb-2">{t('auth.resetPassword')}</h3>
                ...
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      {resetLoading ? t('common.loading') : t('common.send')}
                    </button>
                  </div>
                </form>
              </>
